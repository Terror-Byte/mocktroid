...
public class CameraController : MonoBehaviour
{
    ...
    private float smoothSpeed = 0.125f; // The bigger this value, the quicker the camera snaps to the target. The slower it is, the longer it takes. Place between 0 and 1.
    private Vector3 offset; // If target is set to not be the player, change offset X to be 0!
